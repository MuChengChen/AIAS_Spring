...
class CpxCalTest(dut:CpxCal) extends PeekPokeTester(dut){
    ...
    val golden = Seq(("51=",51),
                     ...
                     ("(((((((((8-3)*2-4)*3-2)*4-1)*3+5)*2-1)*3+2)*2+4)*3+8)*4-1234567890*98271811098-244817292034*(674373294052-3472781923742)*7823924729230=",0/*5360161621000000000000000000000000000*/))
