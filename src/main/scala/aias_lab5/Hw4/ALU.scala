...
class ALU extends Module{
  ...
  val sra = Wire(SInt(32.W))
  sra := (io.src1>>io.src2(4,0)).asSInt
  ...
  when(io.opcode==="b0010011".U||io.opcode==="b0110011".U){
    ...
    XOR -> (io.src1^io.src2),
    SRL_SRA -> Mux(io.funct7===SUB_SRA,(sra.asUInt),(io.src1>>io.src2(4,0))),
    OR -> (io.src1 | io.src2),
    AND -> (io.src1 & io.src2)
  ))
  }.otherwise{
    io.out :=(io.src1.asSInt+io.src2.asSInt).asUInt
  }
